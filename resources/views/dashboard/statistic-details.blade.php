...
<div class="details-container">
    ...
    <div class="table-container">
        <div class="table-actions">
            ...
            @if($data->count() > 0)
                <a href="{{ route('dashboard.export-statistic', ['type' => $type]) }}" class="export-btn">
                ...
                <tbody>
                    @foreach($data as $index => $labour)
                        <tr>
                            ...
                            <td>
                                @if($labour->labour_visa_status)
                                    <span class="visa-status {{ 
                                        $labour->labour_visa_status == 'อนุมัติ' ? 'approved' : 
                                        ($labour->labour_visa_status == 'ไม่อนุมัติ' ? 'rejected' : 'pending') 
                                    }}">
                                        {{ $labour->labour_visa_status }}
                                    </span>
                                @else
                                    <span class="visa-status pending">-</span>
                                @endif
                            </td>
                            <td>
